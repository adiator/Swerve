...
class Model() {
    ...
    private var w1:NDArray = uninitialized
    private var w2:NDArray = uninitialized
    private var w3:NDArray = uninitialized
    private var b1:NDArray = uninitialized
    private var b2:NDArray = uninitialized
    private var b3:NDArray = uninitialized
    private var x_mean:NDArray = uninitialized
    private var x_std:NDArray = uninitialized
    private var y_mean:NDArray = uninitialized
    private var y_std:NDArray = uninitialized


    def load():Unit= {
        w1 = manager.create(Array(
            Array(
                0.1583719104528427f,
                0.193258598446846f,
        ...
        b2 = manager.create(-0.6214818358421326f)
        x_mean = manager.create(134.38143920898438f)
        x_std = manager.create(59.40098190307617f)
        y_mean = manager.create(1.1227589845657349f)
        y_std = manager.create(0.7045105695724487f)
    }
